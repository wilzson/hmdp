...
import com.dpxt.utils.RegexUtils;
...
import static com.dpxt.utils.RedisConstants.*;
import static com.dpxt.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result sendCode(String phone, HttpSession session) {
        ...
        // 4.保存验证码到 session (业务前缀+key, value, 限制时间120， 时间单位)
